...
| `src/addons/` | Opt-in modules built separately: `testing`, `uiblocks`, `netblocks`, `sensors`, `embodied-control`, `remote-control`, `glasses`, `simulator`, `volumes`, `virtualkeyboard`, ... |
