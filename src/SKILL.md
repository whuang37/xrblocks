...
| [`addons/`](addons)                                                                  | opt-in modules, each often with its own README/skills: `uiblocks`, `netblocks`, `testing`, `sensors`, `embodied-control`, `user-agent-bridge`, `glasses`, `volumes`, `virtualkeyboard`, simulator UI, ... |
