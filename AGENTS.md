...
| `src/addons/` | Opt-in modules built separately: `testing`, `uiblocks`, `netblocks`, `sensors`, `embodied-control`, `user-agent-bridge`, `glasses`, `simulator`, `volumes`, `virtualkeyboard`, ... |
