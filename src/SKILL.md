...
| [`addons/`](addons)                                                                  | opt-in modules, each often with its own README/skills: `uiblocks`, `netblocks`, `testing`, `sensors`, `embodied-control`, `remote-control`, `glasses`, `volumes`, `virtualkeyboard`, simulator UI, ... |
